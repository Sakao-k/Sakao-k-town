...
*/
	...
	public void CrudVehiclesSensor(String operation_type, String target, ArrayList<String> list)
		...
		case "INSERT":
			...
			break;
		case "DELETE":
			System.out.println(vehiclesSensorService.deleteVehiclesSensorById(Integer.parseInt(this.request.getList().get(0))));
		...
		case "UPDATEisInstaled":
			System.out.println(this.vehiclesSensorService.updateVehiclesSensorIsInstalled(Integer.parseInt(this.request.getList().get(0)),
					Boolean.valueOf(this.request.getList().get(1))));
